...
const CategoriesSection = ({ onRequireLogin }) => (
  <div className="py-16 px-4 text-center">
    ...
    <div className="flex flex-wrap justify-center gap-4 mb-10 max-w-4xl mx-auto">
      <button type="button" onClick={onRequireLogin} className="flex items-center gap-2 bg-white border border-slate-200 hover:border-blue-300 shadow-sm px-5 py-3 rounded-xl font-medium text-slate-700 transition-colors">
    ...
    <button type="button" onClick={onRequireLogin} className="text-blue-600 border border-blue-600 hover:bg-blue-50 px-6 py-2.5 rounded-lg font-medium transition-colors">
