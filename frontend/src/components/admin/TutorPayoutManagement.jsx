...
import { 
  CheckCircle2, XCircle, QrCode, Building2, CreditCard, Loader2, Check 
} from 'lucide-react';
          ...
          <div className="bg-white rounded-3xl p-8 max-w-lg w-full shadow-2xl border border-slate-100 animate-in zoom-in-95 duration-200 max-h-[90vh] overflow-y-auto">
            {actionType === 'approve' ? (
              <div className="space-y-6 text-center">
                ...
                <div>
                  <label htmlFor="adminNote" className="block text-left text-xs font-bold uppercase text-slate-700 mb-1.5">Ghi chú xác nhận (gửi tới Gia sư)</label>
                  <input
                    id="adminNote"
                    type="text"
                    value={adminNote}
              ...
              <div className="space-y-6 text-center">
                ...
                <div className="text-left">
                  <label htmlFor="adminNoteReject" className="block text-xs font-bold uppercase text-slate-700 mb-2">Lý do từ chối <span className="text-rose-500">*</span></label>
                  <textarea
                    id="adminNoteReject"
                    rows={3}
                    value={adminNote}
