...
import { GraduationCap, CheckCircle, Clock, Edit2, Trash2, KeyRound, BookOpen, Loader2 } from 'lucide-react';
              ...
              <td className="px-6 py-4">
                {tutor.status === 'Đang dạy' ? (
                  <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-emerald-50 text-emerald-700 border border-emerald-200">
                    <CheckCircle className="w-3.5 h-3.5 mr-1" /> {tutor.status}
                  </span>
                ) : (
                  <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-amber-50 text-amber-700 border border-amber-200">
                    <Clock className="w-3.5 h-3.5 mr-1" /> {tutor.status}
                  </span>
                )}
              </td>
