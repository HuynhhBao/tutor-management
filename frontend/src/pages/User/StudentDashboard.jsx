...
const StudentDashboard = () => {
  ...
  const stats = [
    ...
    { label: 'Gia sư đang thuê', value: '0', icon: Star, color: 'text-purple-600', bg: 'bg-purple-50' },
        ...
        <div className="relative z-10">
          ...
          <div className="mt-6 flex flex-wrap gap-4">
            <button 
              ...
              className="px-6 py-2.5 bg-purple-600 text-white font-bold rounded-xl hover:bg-purple-700 transition-all flex items-center gap-2 shadow-lg shadow-purple-200"
            >
              Bắt đầu tìm gia sư
              <ArrowRight className="w-4 h-4" />
            </button>
            <div className="flex items-center gap-2 text-sm text-slate-500 px-4 py-2 bg-slate-50 rounded-xl border border-slate-100">
              <ShieldCheck className="w-4 h-4 text-emerald-500" />
              Giao dịch an toàn & minh bạch
            </div>
          </div>
        </div>
        <div className="absolute top-0 right-0 w-64 h-64 bg-purple-50 rounded-full -mr-20 -mt-20 z-0 opacity-50" />
          ...
          {quickActions.map((action, idx) => {
            ...
            return (
              <button
                ...
                className="group bg-white p-6 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md hover:border-purple-200 transition-all text-left flex flex-col"
              >
                ...
                <div className="mt-4 flex items-center text-purple-600 text-sm font-bold opacity-0 group-hover:opacity-100 transition-opacity">
                  Xem ngay
